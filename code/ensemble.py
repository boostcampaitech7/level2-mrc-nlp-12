...
if __name__ == "__main__":
    ...
    parser.add_argument('--predictions_dir', type=str, default='predictions_for_ensemble', help='Directory containing prediction JSON files.')
    parser.add_argument('--output_dir', type=str, default='ensemble_outputs', help='Directory to save ensemble results.')
    parser.add_argument('--method', type=str, choices=['hard', 'soft'], default='hard', help='Voting method: hard or soft.')
