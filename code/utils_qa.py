...
def prepare_train_features(
    examples, tokenizer, column_names, max_seq_length, training_args, data_args
):
    ...
    tokenized_examples = tokenizer(
        ...
        return_token_type_ids=training_args.return_token_type_ids,
...
def post_processing_function(
    examples, features, predictions, training_args, data_args, column_names, datasets
):
    """
