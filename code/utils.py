...
def get_arguments(experiment_dir: str, experiment_type: str):
    ...
    args_json_path = (
        "../args.json" if experiment_type == "train" else "../args_inference.json"
    )
    ...
    if "output_dir" not in json_args or not json_args["output_dir"]:
